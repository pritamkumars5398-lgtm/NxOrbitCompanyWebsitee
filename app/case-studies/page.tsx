...
export default function CaseStudiesPage() {
  return (
    <>
      ...
      <CallToAction
        eyebrow="Your turn"
        title="Let's write the next one together."
        description="Tell us the problem you're solving. We'll tell you honestly whether we're the right team for it."
        secondary={{ label: "Browse the portfolio", href: "/portfolio" }}
      />
    </>
  );
}
